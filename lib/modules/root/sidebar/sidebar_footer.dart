...
import 'package:flutter/material.dart' show Badge, ColoredBox;
...
class SidebarFooter extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    if (mediaQuery.mdAndDown) {
      // Keep the compact rail footer transparent: the rail manages its own
      // surface, and the overlap issue is specific to the expanded sidebar.
      return Column(
            ...
            SizedBox(
              ...
              child: Button(
                ...
                trailing: downloadCount > 0
                    ? CountBadge(downloadCount.toString())
                    : null,
